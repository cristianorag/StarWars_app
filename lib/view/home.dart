  ...
  void _loadAvatar() async {
    ...
    if (loadedConfig != null) {
      await pref.setString(
          'fluttermojiSelectedOptions', loadedConfig.avatarConfigData);
    }
  }
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton(
                              onPressed: () {
                                Navigator.of(context)
                                    .pushNamed(RouteGenerator.officialSite);
                              },
                              style: ButtonStyle(
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.of(context)
                                    .pushNamed(RouteGenerator.avatarEditing);
                              },
                ...
                if (snapshot.connectionState == ConnectionState.none ||
                  ...
                  if (snapshot.hasData) {
                    if (snapshot.hasError) {
                      ...
                      return FavoratableListView(snapshot.data, _favorites,
                          onFavorite: (model) {
                        if (model.favorite) {
