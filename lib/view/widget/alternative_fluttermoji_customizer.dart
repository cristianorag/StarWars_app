...
import 'package:star_wars/controller/avatar_config_controller.dart';
import 'package:star_wars/controller/avatar_controller.dart';
import 'package:star_wars/model/avatar_config_model.dart';
import 'package:star_wars/model/avatar_config_repository.dart';
...
class AlternativeFluttermojiCustomizer extends StatefulWidget {
  ...
  @override
  _AlternativeFluttermojiCustomizerState createState() =>
      _AlternativeFluttermojiCustomizerState();
}

class _AlternativeFluttermojiCustomizerState
    extends State<AlternativeFluttermojiCustomizer>
    with SingleTickerProviderStateMixin {
  AvatarController _avatarController = AvatarController(AvatarRepository());
  AvatarConfigController _avatarConfigController =
      AvatarConfigController(AvatarConfigRepository());
              ...
              children: [
                ...
                IconButton(
                  onPressed: () async {
                    ...
                    _avatarController
                        .save(AvatarModel(pref.getString('fluttermoji')!));
                    _avatarConfigController.save(AvatarConfigModel(
                        jsonEncode(fluttermojiController.selectedIndexes)));
